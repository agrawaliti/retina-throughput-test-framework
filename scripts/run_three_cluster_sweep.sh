...
# Core-count knobs (env-overridable). Defaults tuned for 32-core Standard_D32s_v3.
# For 176-core Standard_HX176rs, source scenarios/hx_176core.env (LISTENERS=175, etc.).
LISTENERS="${LISTENERS:-31}"
WORKERS="${WORKERS:-124}"
RECEIVER_GOMAXPROCS="${RECEIVER_GOMAXPROCS:-31}"
CLIENT_GOMAXPROCS="${CLIENT_GOMAXPROCS:-3}"
CLIENT_PODS="${CLIENT_PODS:-15}"
